...
datafile_path = '/Users/honeyeah/Codes/LuxProject/data/dwarfs_rel_most_rel.pkl'
df_stars = pd.read_pickle(datafile_path)
n_stars = 500
labels = ['teff', 'logg', 'fe_h', 'mg_h', 'si_h', 'ni_h', 'ca_h']
...
df.to_csv("latent_scan_results_dwarfs.csv", index=False)
